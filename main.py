...
from DataProcessor import DocumentProcessor
from DataProcessor import EmbeddingClient
from DataProcessor import ChromaCollectionCreator
from QuizHandler import QuizGenerator
from QuizHandler import QuizManager

if __name__ == "__main__":
    
    embed_config = {
        "model_name": "text-embedding-004",
        "project": "gemini-quizzify-424119",
    ...
    if st.session_state.display_quiz:
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                if answer is None and answer_choice == True:
